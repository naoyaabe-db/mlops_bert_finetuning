...
# MAGIC %md
# MAGIC # (モデル検証成功) ステージングへのモデルのデプロイ・サービング
# MAGIC <br/>
...
model_version = client.get_model_version_by_alias(registered_model_full_path, "Staging")

serving_endpoint_name = stg_serving_endpoint_name
...
displayHTML(f'Your Model Endpoint Serving is now available. Open the <a href="/ml/endpoints/stg_{serving_endpoint_name}">Model Serving Endpoint page</a> for more details.')
